...
Eigen::VectorXd my_time; // 6*1 走每段轨迹的时间
int point_num;

ros::Publisher setpoint_pub; // 发布所选的设置点
ros::Publisher traj_pub; // 发布轨迹path.poses
ros::Publisher traj_point_pub; // 发布轨迹上移动的点，可视化运动
